...
SECRET_KEY = 'django-insecure-@@h2l@rh_xr6*d%=%buzif_jtlj$bd!n_t32)#d)+-%_g1x$@q'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'dic@rcdeportivo.es'
EMAIL_HOST_PASSWORD = '76911288Rr'
DEFAULT_FROM_EMAIL = 'dic@rcdeportivo.es'
